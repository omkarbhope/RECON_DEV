...
class tbl_workflow_details(models.Model):
    ...
    screen_name = models.ForeignKey("tbl_workflow_level_data_details", default=0, verbose_name="Screen", on_delete=models.PROTECT,related_name="field")
    field_name = models.ForeignKey("tbl_workflow_level_data_details", default=0, verbose_name="field Name", on_delete=models.PROTECT)
    currency_id = models.ForeignKey("Tbl_Currency_Mst", on_delete=models.CASCADE, blank=True, null=True)
...
class tbl_workflow_level_data_details(models.Model):
    header_ref_id = models.ForeignKey("tbl_workflow_level_data_mst", default=0,verbose_name="Header Ref ID",on_delete=models.CASCADE,related_name='workflowLevelDetailsRow')
    level = models.IntegerField(default=0,verbose_name='Level')
    activity_ref_id = models.ForeignKey("tbl_workflow_activity_mst", default=0, verbose_name="Activity Ref Id", on_delete=models.PROTECT)
    sequence_number = models.IntegerField(default=0,verbose_name="Sequence Number")
    action_ref_id =  models.ForeignKey("tbl_workflow_action_mst", default=0, verbose_name="Action Ref Id", on_delete=models.PROTECT)
