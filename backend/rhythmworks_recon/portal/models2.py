...
class tbl_login_mst(models.Model):
    ...
    '''
    user = models.OneToOneField(User,max_length=140, default=0,on_delete = models.CASCADE,related_name='userRow')
...
class Tbl_Currency_Mst(models.Model):
    ...
    country_id = models.ForeignKey('Tbl_Country_Mst',on_delete=models.CASCADE,related_name='currency')
    is_active = models.CharField(default='Y',max_length=1,verbose_name='Is Active')
    is_deleted = models.CharField(max_length=1, default='N',verbose_name="Is Deleted")
    created_date_time = models.DateTimeField(default=timezone.localtime,verbose_name="Created Date Time")
    created_by = models.IntegerField(default=0,verbose_name="Created By")
...
class tbl_company_mst(models.Model):
    ...
    contact_person_mobile_number = models.CharField(null=True,max_length=30)
    ...
    def save(self, *arg, **kwargs):
        last_object = tbl_company_mst.objects.last()
        if(last_object == None):
            last_object = QueryDict(mutable=True)
            last_object.id = 0
        print(last_object)
...
class tbl_transaction_type_mst(models.Model):
    ...
    is_accounting_required = models.BooleanField(default=False,verbose_name='Is Accounting Required')
    ...
    # tbl_sub_accounting = models.CharField(max_length=100,verbose_name='Accounting Table Name',null=True,blank=True)
    # ref_id_2_coloumn_name = models.CharField(max_length=40,verbose_name='Reference Id 2 Coloumn Name',null=True,blank=True)
    is_active = models.CharField(default='Y',max_length=1,verbose_name='Is Active')
    is_deleted = models.CharField(max_length=1, default='N',verbose_name="Is Deleted")
    created_date_time = models.DateTimeField(default=timezone.localtime,verbose_name="Created Date Time")
    created_by = models.IntegerField(default=0,verbose_name="Created By")
...
class tbl_channel_mst(models.Model):
    share_id = models.IntegerField(default=0,verbose_name='Share ID')
    company_ref_id = models.ForeignKey("tbl_company_mst", default=0, verbose_name="Company Ref Id", on_delete=models.PROTECT,related_name='companies')
    name = models.CharField(max_length=20,verbose_name='Name')
    is_active = models.CharField(default='Y',max_length=1,verbose_name='Is Active')
    is_deleted = models.CharField(max_length=1, default='N',verbose_name="Is Deleted")
    created_date_time = models.DateTimeField(default=timezone.localtime,verbose_name="Created Date Time")
...
class tbl_source_mst(models.Model):
    share_id = models.IntegerField(default=0,verbose_name='Share ID')
    company_ref_id = models.ForeignKey("tbl_company_mst", default=0, verbose_name="Company Ref Id", on_delete=models.PROTECT,related_name="company")
    channel_ref_id = models.ForeignKey("tbl_channel_mst", default=0, verbose_name="Channel Ref Id", on_delete=models.PROTECT)
    network_type_ref_id = models.ForeignKey("tbl_master", default=0, verbose_name="Network Type Ref Id", on_delete=models.PROTECT,related_name="Network_Type")
    source_name  = models.CharField(max_length=20,verbose_name='Source Name')
...
class tbl_source_details(models.Model):
    header_ref_id = models.ForeignKey("tbl_source_mst", default=0,verbose_name="Header Ref ID",on_delete=models.CASCADE,related_name='initialItemRow')
    section_identifier_id = models.ForeignKey("tbl_master", default=0,verbose_name="Section Reference ID",on_delete=models.CASCADE,related_name="Section_Type")
    field_name = models.CharField(max_length=20,verbose_name="Field Name")
    field_data_type_ref_id = models.ForeignKey("tbl_master", default=0,verbose_name="Field Data Type ID",on_delete=models.PROTECT,related_name="Field_Type")
    field_length = models.CharField(verbose_name='Field Length',max_length=20)
...
class tbl_api_definition_standard_details(models.Model):
    header_ref_id = models.ForeignKey("tbl_api_definition_standard_mst", default=0,verbose_name="Header Ref ID",on_delete=models.PROTECT,related_name='initialItemRow')
...
class tbl_api_definition_mst(models.Model):
    share_id = models.IntegerField(default=0,verbose_name='Share ID')
    name = models.CharField(max_length=20,verbose_name='API Name')
    ...
    class Meta:
        constraints = [
           models.UniqueConstraint(fields = ['name','company_ref_id','channel_ref_id'], condition=models.Q(is_deleted = 'N'), name='tbl_api_definition_mst unique if not deleted')
       ]

class tbl_api_definition_details(models.Model):
    header_ref_id = models.ForeignKey("tbl_api_definition_mst", default=0,verbose_name="Header Ref ID",on_delete=models.PROTECT,related_name='initialItemRow')
    api_field_name = models.CharField(max_length=20,verbose_name='API Field Name')
    api_field_data_type_ref_id = models.ForeignKey("tbl_master", default=0,verbose_name="API Data Type Ref ID",on_delete=models.PROTECT,related_name='api_field_data_type')
    ...
    field_name =models.CharField(max_length=20,verbose_name='Field Name')
    field_data_type_ref_id = models.ForeignKey("tbl_master", default=0,verbose_name="Field Data Type Ref ID",on_delete=models.PROTECT)
...
class tbl_reconcilation_process_mst(models.Model):
    ...
    reconcilation_ref_id = models.ForeignKey("tbl_reconcilation_definition_mst", default=0,verbose_name="Reconcilation Ref ID",on_delete=models.PROTECT)
    is_active = models.CharField(default='Y',max_length=1,verbose_name='Is Active')
    is_deleted = models.CharField(max_length=1, default='N',verbose_name="Is Deleted")
    created_date_time = models.DateTimeField(default=timezone.localtime,verbose_name="Created Date Time")
    created_by = models.IntegerField(default=0,verbose_name="Created By")
...
class tbl_reconcilation_process_details(models.Model):
    ...
    request_type_ref_id =models.ForeignKey("tbl_master", default=0,verbose_name="Request Type Ref ID",on_delete=models.PROTECT,related_name='api_request_type')
    is_active = models.CharField(default='Y',max_length=1,verbose_name='Is Active')
    is_deleted = models.CharField(max_length=1, default='N',verbose_name="Is Deleted")
    created_date_time = models.DateTimeField(default=timezone.localtime,verbose_name="Created Date Time")
    created_by = models.IntegerField(default=0,verbose_name="Created By")
...
class tbl_workflow_details(models.Model):
    header_ref_id = models.ForeignKey("tbl_workflow_mst", default=0,verbose_name="Header Ref ID",on_delete=models.CASCADE,related_name='workflowDetailsRow')
    level = models.ForeignKey("tbl_workflow_level_data_details", default=0, verbose_name="Level", on_delete=models.PROTECT,related_name="level_id")
    screen_name = models.ForeignKey("tbl_workflow_screen_linking_mst", default=0, verbose_name="Screen", on_delete=models.PROTECT,related_name="field")
    field_name = models.ForeignKey("tbl_workflow_screen_linking_mst", default=0, verbose_name="field Name", on_delete=models.PROTECT)
    currency_id = models.ForeignKey("Tbl_Currency_Mst", on_delete=models.CASCADE, blank=True, null=True)
    approval_amount = models.DecimalField(default=0,max_digits=15,decimal_places=4,verbose_name="Approval Amount")
    is_approval_required = models.BooleanField(blank=False)
    is_active = models.CharField(default='Y',max_length=1,verbose_name='Is Active')
    is_deleted = models.CharField(max_length=1, default='N',verbose_name="Is Deleted")
    created_date_time = models.DateTimeField(default=timezone.localtime,verbose_name="Created Date Time")
    created_by = models.IntegerField(default=0,verbose_name="Created By")
...
class tbl_workflow_sub_details(models.Model):
    details_ref_id = models.ForeignKey("tbl_workflow_mst", default=0,verbose_name="Details Ref ID",on_delete=models.PROTECT)
    header_details_ref_id = models.ForeignKey("tbl_workflow_details", default=0,verbose_name="Header Ref ID",on_delete=models.PROTECT,related_name='workflowdetailsDetailsRow')
    company_ref_id = models.ForeignKey("tbl_company_mst", default=0, verbose_name="Company Ref Id", on_delete=models.PROTECT)
    level = models.ForeignKey("tbl_workflow_level_data_details", default=0, verbose_name="Entity Ref Id", on_delete=models.PROTECT)
    role_ref_id = models.ForeignKey("tbl_role_mst", default=0, verbose_name="Role Ref Id", on_delete=models.PROTECT)
    employee_ref_id = models.ForeignKey("tbl_employee_mst", default=0, verbose_name="Employee Ref Id", on_delete=models.PROTECT)
    ...
    sla_days = models.ForeignKey("tbl_master", default=0, verbose_name="SLA Days Ref Id", on_delete=models.PROTECT,related_name='sladaysDetailsRow')
    reminder_days = models.ForeignKey("tbl_master", default=0, verbose_name="Reminder Days Ref Id", on_delete=models.PROTECT,related_name='reminderdaysDetailsRow')
    currency_id = models.ForeignKey("tbl_currency_mst", on_delete=models.CASCADE, blank=True, null=True)
    approval_amount = models.DecimalField(default=0,max_digits=15,decimal_places=4,verbose_name="Approval Amount")
    is_approval_required = models.BooleanField(blank=False)
    is_active = models.CharField(default='Y',max_length=1,verbose_name='Is Active')
...
class tbl_workflow_screen_linking_mst(models.Model):
    share_id = models.IntegerField(default=0,verbose_name='Share ID')
    workflow_ref_id = models.CharField(max_length=15,verbose_name='Workflow name')
    left_panel_ref_id = models.ForeignKey("tbl_left_panel", default=0, verbose_name="Left Panel Ref Id", on_delete=models.PROTECT)
    database_field_name = models.CharField(max_length=100,verbose_name="Database Field Ref Name")
    label_field_name = models.CharField(max_length=100,verbose_name="Front End Field Name")
    is_active = models.CharField(default='Y',max_length=1,verbose_name='Is Active')
    is_deleted = models.CharField(max_length=1, default='N',verbose_name="Is Deleted")
    created_date_time = models.DateTimeField(default=timezone.localtime,verbose_name="Created Date Time")
    created_by = models.IntegerField(default=0,verbose_name="Created By")
